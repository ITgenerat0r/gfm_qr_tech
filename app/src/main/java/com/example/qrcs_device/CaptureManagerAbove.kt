...
//            )
    ...
    fun initializeFromIntent(intent: Intent?, savedInstanceState: Bundle?) {
        ...
        if (intent != null) {
            ...
            if (Intents.Scan.ACTION.equals(intent.action)) {
    ...
    private fun openCameraWithPermission() {
        if (ContextCompat.checkSelfPermission(activity, Manifest.permission.CAMERA)
            ...
            ActivityCompat.requestPermissions(
                activity, arrayOf<String>(Manifest.permission.CAMERA),
...
//            message = activity.getString(R.string.zxing_msg_camera_framework_bug)
            message = "R.string.zxing_msg_camera_framework_bug"
        }
        val builder: AlertDialog.Builder = AlertDialog.Builder(activity)
        builder.setTitle("QR device")
    ...
    companion object {
        private val TAG = CaptureManagerCustom::class.java.simpleName
