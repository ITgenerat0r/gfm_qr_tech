...
QRCode.prototype.svg = function(opt) {
  ...
  var bgrect = typeof options.background != "undefined" ? indent + '<rect x="0" y="0" width="' + width + '" height="' + height + '" style="fill:' + options.background + ';shape-rendering:crispEdges;"/>' + EOL : "";
  ...
  for (var y = 0; y < length; y++) {
    for (var x = 0; x < length; x++) {
      ...
      if (module) {
        ...
        var px = (x * xsize + options.padding * xsize) + options.offset[0];
        var py = (y * ysize + options.padding * ysize) + options.offset[1];
